const C3 = new Audio("/sounds/C3-tab.mp3");
const Chash3 = new Audio("/sounds/Ch3-(1).mp3");
const D3 = new Audio("/sounds/D3-q.mp3");
const Dhash3 = new Audio("/sounds/Dh3-(2).mp3");
const E3 = new Audio("/sounds/E3-w.mp3");
const F3 = new Audio("/sounds/F3-e.mp3");
const Fhash3 = new Audio("/sounds/Fh3-(4).mp3");
const G3 = new Audio("/sounds/G3-r.mp3");
const Ghash3 = new Audio("/sounds/Gh3-(5).mp3");
const A3 = new Audio("/sounds/A3-t.mp3");
const Ahash3 = new Audio("/sounds/Ah3-(6).mp3");
const B3 = new Audio("/sounds/B3-y.mp3");
const C4 = new Audio("/sounds/C4-u.mp3");
const Chash4 = new Audio("/sounds/Ch4-(8).mp3");
const D4 = new Audio("/sounds/D4-i.mp3");
const Dhash4 = new Audio("/sounds/Dh4-(9).mp3");
const E4 = new Audio("/sounds/E4-o.mp3");
const F4 = new Audio("/sounds/F4-p.mp3");
const Fhash4 = new Audio("/sounds/Fh4-(a).mp3");
const G4 = new Audio("/sounds/G4-z.mp3");
const Ghash4 = new Audio("/sounds/Gh4-(s).mp3");
const A4 = new Audio("/sounds/A4-x.mp3");
const Ahash4 = new Audio("/sounds/Ah4-(d).mp3");
const B4 = new Audio("/sounds/B4-c.mp3");
const C5 = new Audio("/sounds/C5-v.mp3");
const Chash5 = new Audio("/sounds/Ch5-(g).mp3");
const D5 = new Audio("/sounds/D5-b.mp3");
const Dhash5 = new Audio("/sounds/Dh5-(h).mp3");
const E5 = new Audio("/sounds/E5-n.mp3");
const F5 = new Audio("/sounds/F5-m.mp3");
const Fhash5 = new Audio("/sounds/Fh5-(k).mp3");
const G5 = new Audio("/sounds/G5-comma.mp3");
const Ghash5 = new Audio("/sounds/Gh5-(l).mp3");
const A5 = new Audio("/sounds/A5-dot.mp3");
const Ahash5 = new Audio("/sounds/Ah5-semi.mp3");
const B5 = new Audio("/sounds/B5-slash.mp3");
const C6 = new Audio("/sounds/C6-shift.mp3");
...
const playC3 = () => {
  ...
  setTimeout(() => {
    C3key.classList.remove("whiteShadow");
  }, 200); //setTimeout (function () {}, sec);
};
...
const playCh3 = () => {
  ...
  setTimeout(() => {
    Ch3key.classList.remove("blackPress");
  }, 200);
  setTimeout(() => {
    Ch3key.classList.remove("blackShadow");
  }, 200);
};
...
const playD3 = () => {
  ...
  setTimeout(() => {
    D3key.classList.remove("whiteShadow");
  }, 200);
};
...
const playDh3 = () => {
  ...
  setTimeout(() => {
    Dh3key.classList.remove("blackPress");
  }, 200);
  Dh3key.classList.add("blackShadow");
  setTimeout(() => {
    Dh3key.classList.remove("blackShadow");
  }, 200);
};
...
const playE3 = () => {
  ...
  setTimeout(() => {
    E3key.classList.remove("whiteShadow");
  }, 200);
};
...
const playF3 = () => {
  ...
  setTimeout(() => {
    F3key.classList.remove("whiteShadow");
  }, 200);
};
...
const playFh3 = () => {
  ...
  setTimeout(() => {
    Fh3key.classList.remove("blackPress");
  }, 200);
  Fh3key.classList.add("blackShadow");
  setTimeout(() => {
    Fh3key.classList.remove("blackShadow");
  }, 200);
};
...
const playG3 = () => {
  ...
  setTimeout(() => {
    G3key.classList.remove("whiteShadow");
  }, 200);
};
...
const playGh3 = () => {
  ...
  setTimeout(() => {
    Gh3key.classList.remove("blackPress");
  }, 200);
  Gh3key.classList.add("blackShadow");
  setTimeout(() => {
    Gh3key.classList.remove("blackShadow");
  }, 200);
};
...
const playA3 = () => {
  ...
  setTimeout(() => {
    A3key.classList.remove("whiteShadow");
  }, 200);
};
...
const playAh3 = () => {
  ...
  setTimeout(() => {
    Ah3key.classList.remove("blackPress");
  }, 200);
  Ah3key.classList.add("blackShadow");
  setTimeout(() => {
    Ah3key.classList.remove("blackShadow");
  }, 200);
};
...
const playB3 = () => {
  ...
  setTimeout(() => {
    B3key.classList.remove("whiteShadow");
  }, 200);
};
...
const playC4 = () => {
  ...
  setTimeout(() => {
    C4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playCh4 = () => {
  ...
  setTimeout(() => {
    Ch4key.classList.remove("blackPress");
  }, 200);
  Ch4key.classList.add("blackShadow");
  setTimeout(() => {
    Ch4key.classList.remove("blackShadow");
  }, 200);
};
...
const playD4 = () => {
  ...
  setTimeout(() => {
    D4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playDh4 = () => {
  ...
  setTimeout(() => {
    Dh4key.classList.remove("blackPress");
  }, 200);
  Dh4key.classList.add("blackShadow");
  setTimeout(() => {
    Dh4key.classList.remove("blackShadow");
  }, 200);
};
...
const playE4 = () => {
  ...
  setTimeout(() => {
    E4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playF4 = () => {
  ...
  setTimeout(() => {
    F4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playFh4 = () => {
  ...
  setTimeout(() => {
    Fh4key.classList.remove("blackPress");
  }, 200);
  Fh4key.classList.add("blackShadow");
  setTimeout(() => {
    Fh4key.classList.remove("blackShadow");
  }, 200);
};
...
const playG4 = () => {
  ...
  setTimeout(() => {
    G4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playGh4 = () => {
  ...
  setTimeout(() => {
    Gh4key.classList.remove("blackPress");
  }, 200);
  Gh4key.classList.add("blackShadow");
  setTimeout(() => {
    Gh4key.classList.remove("blackShadow");
  }, 200);
};
...
const playA4 = () => {
  ...
  setTimeout(() => {
    A4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playAh4 = () => {
  ...
  setTimeout(() => {
    Ah4key.classList.remove("blackPress");
  }, 200);
  Ah4key.classList.add("blackShadow");
  setTimeout(() => {
    Ah4key.classList.remove("blackShadow");
  }, 200);
};
...
const playB4 = () => {
  ...
  setTimeout(() => {
    B4key.classList.remove("whiteShadow");
  }, 200);
};
...
const playC5 = () => {
  ...
  setTimeout(() => {
    C5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playCh5 = () => {
  ...
  setTimeout(() => {
    Ch5key.classList.remove("blackPress");
  }, 200);
  Ch5key.classList.add("blackShadow");
  setTimeout(() => {
    Ch5key.classList.remove("blackShadow");
  }, 200);
};
...
const playD5 = () => {
  ...
  setTimeout(() => {
    D5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playDh5 = () => {
  ...
  setTimeout(() => {
    Dh5key.classList.remove("blackPress");
  }, 200);
  Dh5key.classList.add("blackShadow");
  setTimeout(() => {
    Dh5key.classList.remove("blackShadow");
  }, 200);
};
...
const playE5 = () => {
  ...
  setTimeout(() => {
    E5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playF5 = () => {
  ...
  setTimeout(() => {
    F5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playFh5 = () => {
  ...
  setTimeout(() => {
    Fh5key.classList.remove("blackPress");
  }, 200);
  Fh5key.classList.add("blackShadow");
  setTimeout(() => {
    Fh5key.classList.remove("blackShadow");
  }, 200);
};
...
const playG5 = () => {
  ...
  setTimeout(() => {
    G5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playGh5 = () => {
  ...
  setTimeout(() => {
    Gh5key.classList.remove("blackPress");
  }, 200);
  Gh5key.classList.add("blackShadow");
  setTimeout(() => {
    Gh5key.classList.remove("blackShadow");
  }, 200);
};
...
const playA5 = () => {
  ...
  setTimeout(() => {
    A5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playAh5 = () => {
  ...
  setTimeout(() => {
    Ah5key.classList.remove("blackPress");
  }, 200);
  Ah5key.classList.add("blackShadow");
  setTimeout(() => {
    Ah5key.classList.remove("blackShadow");
  }, 200);
};
...
const playB5 = () => {
  ...
  setTimeout(() => {
    B5key.classList.remove("whiteShadow");
  }, 200);
};
...
const playC6 = () => {
  ...
  setTimeout(() => {
    C6key.classList.remove("whiteShadow");
  }, 200);
};
